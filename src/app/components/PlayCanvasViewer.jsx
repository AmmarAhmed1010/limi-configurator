  ...
  return (
    <div className={`relative ${className} w-full h-full`}>
        ...
        <div id="playcanvas-loader" className="absolute inset-0 flex flex-col items-center justify-center bg-[#2B2D2F] z-10 overflow-hidden">
          <div className="flex flex-col items-center justify-center space-y-8">
            ...
            <div className="relative flex items-center justify-center">
              {/* Spinner */}
              <div className="w-24 h-24 absolute border-2 border-t-white border-transparent rounded-full animate-spin"></div>
              {/* Logo */}
      ...
      <iframe
        ...
        // src='https://limi-configurator-for-control-panel.vercel.app/'
